...
public class InvoiceLineServiceImpl implements InvoiceLineService {
	...
	@Inject
	private InvoiceLineRepository invoiceLineServiceImpl;
			...
			for (InvoiceLine invoiceLine : invoice.getInvoiceItems()) {
				...
				if (stateStatus) {
					...
					BigDecimal gstAmount_SGST_Single = value.multiply(productGst.getGstrate())
							.divide(new BigDecimal(100)).divide(new BigDecimal(2));
					BigDecimal gstAmount_CGCT_Single = value.multiply(productGst.getGstrate())
							.divide(new BigDecimal(100)).divide(new BigDecimal(2));
					invoiceLine.setGstRate(productGst.getGstrate());
				...
				System.out.println("Single Entry  Gst : " + productGst.getName() + " Gst Amount :  " + gstAmount);
